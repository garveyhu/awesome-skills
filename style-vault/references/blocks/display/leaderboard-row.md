---
id: blocks/display/leaderboard-row
type: block
name: 榜单行
...
preview: /preview/blocks/display/leaderboard-row
---
...
- 列头永远 uppercase tracking-wider，和表格（`blocks/display/table`）保持一致的"meta"气质
- Top 10 是 sweet spot——11 行起视觉密度会被 stats 列压垮，建议改成 `blocks/display/skill-card` 网格
