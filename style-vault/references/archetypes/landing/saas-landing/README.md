---
id: archetypes/landing/saas-landing
type: archetype
name: SaaS Landing
...
preview: /preview/archetypes/landing/saas-landing
---

# SaaS Landing

> SaaS 营销落地页骨架，仅定义结构与留白节奏，色字由 vibe 注入
...
- 色/字通过 CSS 变量 `--font-sans` / `--color-accent` 注入，不在 archetype 里 hardcode
