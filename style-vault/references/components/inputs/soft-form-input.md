---
id: components/inputs/soft-form-input
type: component
name: 柔边表单输入
...
preview: /preview/components/inputs/soft-form-input
---
...
- `primary-500` 对应 `tokens/palettes/skillhub-teal-mist` 的 teal-500（`#14b8a6`）——换色系时批量换 primary
