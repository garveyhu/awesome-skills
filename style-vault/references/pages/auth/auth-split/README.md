...
preview: /preview/pages/auth/auth-split
---

# Auth Split

> `/login` + `/register` 共用一个页面。左半是 `blocks/form/auth-split-form`，右半（仅 lg+ 屏）是 slate-900→950 渐变的 visual panel + slogan。
